...
if os.path.exists('solution.py'):
    from solution import DB_PATH, Tweet, Twitter, TwitterError, User, create_db
else:
    from main import DB_PATH, Tweet, Twitter, TwitterError, User, create_db  # type:ignore
...
def test_tweet_representation(tweet1: Tweet, tweet2: Tweet, user1: User, user2: User):
    ...
    tweet2.save(user2)
    assert str(tweet2) == '[RT] This is just fine (id=2)'
