...
def test_get_days_in_year():
    assert Date.get_days_in_year(1997) == 365
    assert Date.get_days_in_year(1999) == 365
    assert Date.get_days_in_year(1700) == 365
    assert Date.get_days_in_year(2008) == 366
    assert Date.get_days_in_year(2016) == 366
    assert Date.get_days_in_year(1600) == 366
