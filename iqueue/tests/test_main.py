...
def test_enqueue_item_fails_when_reaches_max_size(queue2: IntegerQueue):
...
def test_head_item_fails_when_empty_queue(queue1: IntegerQueue):
...
def test_load_queue_from_file():
    try:
        ...
        queue = IntegerQueue.load_from_file(str(path))
