...
def test_top_item_fails_when_empty_stack(stack1: IntegerStack):
...
def test_load_stack_from_file():
    try:
        ...
        stack = IntegerStack.load_from_file(str(path))
